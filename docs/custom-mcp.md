...
| Pendant face | [pendant-mcp](https://github.com/shotah/pendant-mcp) | Face / wallpaper / mood. Grant with `image`. Prefix `pendant` |
...
Do not reuse `maps`, `math`, `image`, or `pendant`.
