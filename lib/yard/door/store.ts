...
function migrate(d: DatabaseSync): void {
  ...
  ensureColumn(d, "operator", "languages", "TEXT NOT NULL DEFAULT ''");
  ...
  ensureColumn(d, "sample_turn", "prompt_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "completion_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "total_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "usage_rounds", "INTEGER");
  ensureColumn(d, "sample_turn", "cached_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "cache_write_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "reasoning_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "prompt_audio_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "completion_audio_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "accepted_prediction_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "rejected_prediction_tokens", "INTEGER");
  ensureColumn(d, "sample_turn", "model", "TEXT");
  ensureColumn(d, "sample_turn", "finish_reason", "TEXT");
  ensureColumn(d, "sample_turn", "service_tier", "TEXT");
