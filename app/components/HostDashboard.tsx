      ...
      {mutate ? (
        <DashFold title="Logs" persistKey={craneFoldKey("host", "logs")} hint="gantree container slog — not a crane">
          <p className="mb-2 text-xs text-zinc-600">
            Tails the console container when this process is in Docker. <code className="text-zinc-500">npm start</code> on the
      ...
      {mutate ? (
        ...
        >
          <p className="mb-3 rounded-md border border-amber-900/60 bg-amber-950/40 px-3 py-2 text-xs text-amber-200">
            This file is the yard. Drop a <code className="text-amber-100">[[gantry]]</code> and that crane vanishes from the
