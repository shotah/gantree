...
export function SpendScope({
  ...
  return (
    <div className="flex flex-col items-end gap-1.5">
      <div className="flex flex-wrap justify-end gap-1" role="group" aria-label="Time window">
        {SPEND_WINDOWS.map((w) => (
      ...
      {onBucket && buckets && buckets.length > 0 ? (
        <div className="flex flex-wrap justify-end gap-1" role="group" aria-label="Token grouping">
          {buckets.map((b) => (
