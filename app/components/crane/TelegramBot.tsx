  ...
  return (
    ...
    >
      <p className="mb-3 text-xs text-zinc-600">
        ...
        {" "}
        <code className="text-zinc-500">TELEGRAM_ALLOWED_USERS</code>
        {" "}
        — recreate after save.
      </p>
        ...
        ? (
            <div className="mt-5 border-t border-zinc-800 pt-4">
              ...
              <p className="mt-1 text-xs text-zinc-600">
                <code className="text-zinc-500">/new</code>
                {" "}
                distills the chat into
                <code className="text-zinc-500">SELF.md</code>
                , then
      ...
      <div className="mt-5 border-t border-zinc-800 pt-4">
        ...
        <p className="mt-1 text-xs text-zinc-600">
          ...
          {" "}
          <code className="text-zinc-500">user_id</code>
          ).
        </p>
        <ul className="mt-2 flex flex-wrap gap-1.5">
